...
\begin{DoxyCompactList}\small\item\em Kick off collection of a sequence of samples to be passed to a user-\/provided handler. The A\+DC and Timer will be configured to collect samples at frequency fs. \end{DoxyCompactList}\item 
int \hyperlink{ADC_8h_a2b480ef1a1b6e416cec239c43fb7d7ba}{A\+D\+C\+\_\+\+Collect4\+Chan} (uint32\+\_\+t channels\mbox{[}$\,$\mbox{]}, uint32\+\_\+t fs, void($\ast$handler)(unsigned long))
...
\end{DoxyReturn}
\index{A\+D\+C.\+h@{A\+D\+C.\+h}!A\+D\+C\+\_\+\+Collect4\+Chan@{A\+D\+C\+\_\+\+Collect4\+Chan}}
\index{A\+D\+C\+\_\+\+Collect4\+Chan@{A\+D\+C\+\_\+\+Collect4\+Chan}!A\+D\+C.\+h@{A\+D\+C.\+h}}
\subsubsection[{\texorpdfstring{A\+D\+C\+\_\+\+Collect4\+Chan(uint32\+\_\+t channels[], uint32\+\_\+t fs, void($\ast$handler)(unsigned long))}{ADC_Collect4Chan(uint32_t channels[], uint32_t fs, void(*handler)(unsigned long))}}]{\setlength{\rightskip}{0pt plus 5cm}int A\+D\+C\+\_\+\+Collect4\+Chan (
\begin{DoxyParamCaption}
\item[{uint32\+\_\+t}]{channels\mbox{[}$\,$\mbox{]}, }
\item[{uint32\+\_\+t}]{fs, }
\item[{void($\ast$)(unsigned long)}]{handler}
\end{DoxyParamCaption}
)}\hypertarget{ADC_8h_a2b480ef1a1b6e416cec239c43fb7d7ba}{}\label{ADC_8h_a2b480ef1a1b6e416cec239c43fb7d7ba}
channels\+: 4 element array with each element indiciating one channel to open \index{A\+D\+C.\+h@{A\+D\+C.\+h}!A\+D\+C\+\_\+\+In@{A\+D\+C\+\_\+\+In}}
