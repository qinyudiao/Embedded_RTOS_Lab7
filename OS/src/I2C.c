...
{
    // read 1 byte
    return I2C_read(deviceAddress, targetRegister, data, 1, deviceIndex);
}
...
{
    // write 1 byte
    return I2C_write(deviceAddress, targetRegister, &data, 1, deviceIndex);
}
...
{
    // read 2 bytes
    return I2C_read(deviceAddress, targetRegister, data, 2, deviceIndex);
}
...
{
    // write 2 bytes
    return I2C_write(deviceAddress, targetRegister, data, 2, deviceIndex);
}
...
{
    // read 4 bytes
    return I2C_read(deviceAddress, targetRegister, data, 4, deviceIndex);
}
...
{
    // write 4 bytes
    return I2C_write(deviceAddress, targetRegister, data, 4, deviceIndex);
}
